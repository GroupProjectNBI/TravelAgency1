...
async Task db_reset_to_default(Config config)
{
  ...
  await MySqlHelper.ExecuteNonQueryAsync(config.db, "INSERT INTO users(email, first_name, last_name,role_id, date_of_birth, password) VALUES ('edvin@example.com', 'Edvin', 'Lindborg', 2, '1997-08-20', 'travelagency')");
  await MySqlHelper.ExecuteNonQueryAsync(config.db, "INSERT INTO users(email, first_name, last_name,role_id, date_of_birth, password) VALUES ('admin@example.com', 'Admin', 'Admin', 1, '1970-10-30', 'admin')");
  ...
  await MySqlHelper.ExecuteNonQueryAsync(config.db, "INSERT INTO rooms (hotel_id, room_number, name, capacity, price_per_night) VALUES (1,101,'Single',3,34.34);");
  ...
  await MySqlHelper.ExecuteNonQueryAsync(config.db, "INSERT INTO packages(location_id, name, description, package_type)VALUES(1, 'package_fish', 'a nice fish package for the drunken *hick*', 'Fish');");
  ...
  await MySqlHelper.ExecuteNonQueryAsync(config.db, "INSERT INTO bookings (user_id, location_id, hotel_id, package_id, check_in, check_out, guests, rooms, status, total_price) VALUES (1,3,1,1, '2025-12-24', '2026-01-01', 2, 1, 'pending', 1000.00)");
  await MySqlHelper.ExecuteNonQueryAsync(config.db, "INSERT INTO booking_meals (bookings_id, date, meal_type) VALUES (1, '2025-12-31', 'Dinner')");
